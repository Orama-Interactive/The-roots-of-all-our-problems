...
var checkpoints: Array[Checkpoint] = [
	...
	Checkpoint.new(700, "Navigating its way through the forest, the seed had to avoid the tree tops"),
	Checkpoint.new(1200, "“This forest is way too dense” the seed thought. I won’t be able to root properly here, with so little sun."),
	Checkpoint.new(1700, "But then, the seed lost its train of thought to a cracking sound.", "(sound of a tree being chopped and sound of trees falling)"),
...
class Checkpoint:
	...
	func _init(_pos: float, _text := "", _ambient_text := "") -> void:
		pos = _pos
		text = _text
