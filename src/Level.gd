...
var checkpoints: Array[Checkpoint] = [
	...
	Checkpoint.new(7500, forest_obstacles_2, "", "But as the seed navigated further into the forest it realised that this place is far from safe.", "(sounds of rocks and arrows+new obstacles)"),
	...
	Checkpoint.new(16500, war_obstacles, "", "And everything was calm again.", "(sound of fire)"),
